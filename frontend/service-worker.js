...
var APP_VERSION  = "2.49.0"; // bumped: R4 клавиатура в автокомплитах, R6 предупреждение о пустом враче, R7 обновить с сервера, R8 Enter добавляет позицию, R9 приём из карточек
