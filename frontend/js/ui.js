...
(function () {
  ...
  <!-- VET-007: прививки, сделанные НА этом приёме. Раньше вакцинация была
  ...
  <!-- F4/VET-004: назначения. Отдельной сущностью, а не строкой в тексте:
       ...
       структурированы, и другой врач может их прочитать. -->
  <div id="visit-prescriptions" class="attach-box"></div>

  <div id="visit-vaccinations" class="attach-box"></div>
</div>`;
  }
